...
class Falle(Item):
    ...
    def __init__(self,typ,name,begehbar,aufnehmbar,bild,werte):
        Item.__init__(self,typ,name,begehbar,aufnehmbar,'gfxitems/noitem.gif',werte)   # Werte[0] des Items in Silbertalern
        self._realbild = bild
    ...
    def entdecken(self,held):
        if self._schongespaeht==False:  # nur beim ersten Aufruf wird geprueft, ob die Falle entdeckt wird, damit die Wahrscheinlichkeit nicht durch wiederholten betreten steigt
