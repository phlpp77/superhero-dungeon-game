class Item:
    ...
    def __init__(self,typ,name,begehbar,aufnehmbar,bild,werte):
        ...
        self._aktiv = 0     # -1 immer aktiv; 0 nicht aktiv; >0 Anzahl, wie oft noch aktiviert werden kann - wird intern von abgeleiteten Items in der Benutzen-Methode verwaltet
